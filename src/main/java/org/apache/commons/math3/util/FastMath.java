...
public class FastMath {
    ...
    public static class ExpIntTable {
         ...
         */
        public static final double[] EXP_INT_TABLE_A;
        /** Exponential evaluated at integer values,
         * exp(x) =  expIntTableA[x + EXP_INT_TABLE_MAX_INDEX] + expIntTableB[x+EXP_INT_TABLE_MAX_INDEX]
         */
        public static final double[] EXP_INT_TABLE_B;
    ...
    public static class ExpFracTable {
         ...
         * 1024 = 2^10
         */
        public static final double[] EXP_FRAC_TABLE_A;
        /** Exponential over the range of 0 - 1 in increments of 2^-10
         * exp(x/1024) =  expFracTableA[x] + expFracTableB[x].
         */
        public static final double[] EXP_FRAC_TABLE_B;
